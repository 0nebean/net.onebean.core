...
public abstract class BaseSplitBizManual<T extends BaseIncrementIdModel, K extends BaseSplitDao<T>> implements IBaseSplitBizManual<T> {
	...
	public List<T> find(Pagination pagination, ConditionMap conditions, String suffix) {
		...
		return baseDao.find(pagination, conditionList,null, suffix,null);
	}
	...
	public List<T> find(Pagination pagination, ConditionMap conditions, Sort sort, String suffix) {
		...
		return baseDao.find(pagination, conditionList,sort, suffix,null);
	}
	...
	public List<T> find(ListPageQuery query, Map<String, Object> dp,String suffix) {
		return baseDao.find(query.getPagination(),query.getConditions().getItems(),query.getSort(), suffix,dp);
	}

	@Override
	public List<T> findAll(Map<String, Object> dp,String suffix) {
		return baseDao.find(null, null,null, suffix,dp);
	}

	@Override
	public List<T> findAll(String suffix) {
		return baseDao.find(null, null,null, suffix,null);
	}

	@Override
	public List<T> findAll(Sort sort,String suffix) {
		return baseDao.find(null, null,sort, suffix,null);
	}

	@Override
	public List<T> find(Pagination pagination, List<Condition> conditions,Sort sort,String suffix) {
		return baseDao.find(pagination, conditions,sort, suffix,null);
	}

	@Override
	public List<T> find(Pagination pagination, List<Condition> conditions,String suffix) {
		return baseDao.find(pagination, conditions,null, suffix,null);
	}

	@Override
	public List<T> find(Pagination pagination,Sort sort,String suffix) {
		return baseDao.find(pagination, null,sort, suffix,null);
	}

	@Override
	public List<T> find(Pagination pagination,String suffix) {
		return baseDao.find(pagination, null,null, suffix,null);
	}
