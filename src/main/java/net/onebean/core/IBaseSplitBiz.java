...
public interface IBaseSplitBiz<T extends BaseIncrementIdModel> {
	 ...
	 * @return Integer
	 */
	public Integer searchCount(@Param("param") Map<String, Object> param, String suffix);
	/**
	 * 提供统一的搜索功能
	 * @param param map类型参数
	 * @return List<Map<String, Object>>
	 */
	public List<Map<String, Object>> search(@Param("param") Map<String, Object> param, String suffix);
	/**
	 * 提供统一的搜索功能
	 * @param param map类型参数
	 * @return 泛型实体对象的list
	 */
	public List<T> searchEntity(@Param("param") Map<String, Object> param, String suffix);
